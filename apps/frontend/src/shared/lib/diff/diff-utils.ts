...
import type { DiffCell, SeriesKey, AlgoKey } from "../entities/diff/model/diffCell";

/**
 * Оценка ряда в [0, 100]:
 * 100 — нет ошибки (ряд собран полностью),
 * 0 — ошибка "сразу" или нет данных,
 * промежуток — доля выполненных шагов до ошибки.
 */
export function scoreFromItem(item: Item | undefined | null): number | null {
    ...
    // ошибка, но нормальной информации о n или maxN нет → 0
