...
from typing import Any, TypedDict, cast, TypeAlias

from src.run.params import PrecisionConfig
from src.run.precision import PrecisionType

PrecisionValue: TypeAlias = PrecisionType | str | PrecisionConfig
PrecisionCollection: TypeAlias = Sequence[PrecisionValue] | PrecisionValue | None
