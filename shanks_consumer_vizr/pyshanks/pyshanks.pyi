...
class Arb:
    ...
    def __index__(self) -> int:
        ...
    @typing.overload
    def __init__(self, d: float, precision: int) -> None:
        ...
    @typing.overload
    def __init__(self, s: str, precision: int) -> None:
        ...
...
class NumeratorType:
    ...
    Members:
      ...
      gamma_rho_type
    """
    __members__: typing.ClassVar[dict[str, NumeratorType]]  # value = {'rho_type': <NumeratorType.rho_type: 0>, 'generalized_type': <NumeratorType.generalized_type: 1>, 'gamma_rho_type': <NumeratorType.gamma_rho_type: 2>}
    gamma_rho_type: typing.ClassVar[NumeratorType]  # value = <NumeratorType.gamma_rho_type: 2>
    generalized_type: typing.ClassVar[NumeratorType]  # value = <NumeratorType.generalized_type: 1>
...
class RemainderType:
    ...
    Members:
      ...
      v_wave_type
    """
    __members__: typing.ClassVar[dict[str, RemainderType]]  # value = {'u_type': <RemainderType.u_type: 0>, 't_type': <RemainderType.t_type: 1>, 'v_type': <RemainderType.v_type: 2>, 't_wave_type': <RemainderType.t_wave_type: 3>, 'v_wave_type': <RemainderType.v_wave_type: 4>}
    t_type: typing.ClassVar[RemainderType]  # value = <RemainderType.t_type: 1>
    t_wave_type: typing.ClassVar[RemainderType]  # value = <RemainderType.t_wave_type: 3>
    ...
    v_wave_type: typing.ClassVar[RemainderType]  # value = <RemainderType.v_wave_type: 4>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SeriesBaseCF32:
    def generateSeries(self, x: CF32, vecSize: int, addTParameter: CF32 = ..., addKParameter: int = 1) -> SeriesResultCF32:
        ...
    def get_name(self) -> str:
        ...
...
class SeriesBaseCF64:
    def generateSeries(self, x: CF64, vecSize: int, addTParameter: CF64 = ..., addKParameter: int = 1) -> SeriesResultCF64:
        ...
    def get_name(self) -> str:
        ...
...
class SeriesBaseCFLong:
    ...
    def get_x(self) -> CFLong:
        ...
class SeriesBaseF32:
    def generateSeries(self, x: float, vecSize: int, addTParameter: float = 1.0, addKParameter: int = 1) -> SeriesResultF32:
        ...
    def get_name(self) -> str:
        ...
