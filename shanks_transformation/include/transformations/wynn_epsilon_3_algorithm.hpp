...
public:
     ...
     */
    explicit wynn_epsilon_3_algorithm(const param_type& epsilon_threshold_ = static_cast<param_type>(1e-3)) : 
...
private:
    ...
    const param_type epsilon_threshold;  ///< Threshold for epsilon correction terms to prevent division by near-zero values.
...
T wynn_epsilon_3_algorithm<T, K>::operator()(
    ...
    param_type ERROR, ERR1, ERR2, ERR3;
    ERROR = ERR1 = ERR2 = ERR3 = static_cast<param_type>(0);
    param_type TOL1, TOL2, TOL3;
    TOL1 = TOL2 = TOL3 = static_cast<param_type>(0);
