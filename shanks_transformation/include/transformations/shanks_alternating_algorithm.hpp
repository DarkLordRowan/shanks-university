...
class shanks_transform_alternating final : public series_acceleration<T, K>
{
public:
	 ...
	 */
	explicit shanks_transform_alternating() : series_acceleration<T, K>("shanks original") {};
...
class shanks_transform_alternating<float_precision, K> final : public series_acceleration<float_precision, K>
{
public:
	 ...
	 *        Series terms should be non-alternating for optimal performance
	 */
	explicit shanks_transform_alternating() : series_acceleration<float_precision, K>("shanks original") {};
...
template <UnsignedIntLike K>
class shanks_transform_alternating<complex_precision<float_precision>, K> final : public series_acceleration<complex_precision<float_precision>, K>
{
public:
	 ...
	 *        Series terms should be non-alternating for optimal performance
	 */
	explicit shanks_transform_alternating() : series_acceleration<complex_precision<float_precision>, K>("shanks original") {};
