...
public:
	...
	T next() override {
		...
		else this->current_state *= static_cast<T>(-1) * pow(this->x, static_cast<T>(4)) * static_cast<T>(fma(2,this->n-1,1)) / static_cast<T>(fma(2,this->n,1));
