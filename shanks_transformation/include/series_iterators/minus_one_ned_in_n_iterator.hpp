...
/**
* @brief Maclaurin series of -x*0.78343051 function
...
public:
	...
	T sum() const override{
		...
		return this->x * static_cast<T>(-0.78343051);
	}
	...
	T next() override {
		...
		this->current_state = utils::minus_one_raised_to_power_n<T, K>(this->n + 1) * this->x / static_cast<T>(pow(this->n+1, this->n+1));
		this->n+=1;
