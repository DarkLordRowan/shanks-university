...
#include "wynn_rho_algorithm.hpp"

template<typename T, typename K, typename series_templ>
T wynn_rho_algorithm<T, K, series_templ>::calculate(const K n, int order) const {
    if (order & 1) {
        ++order;
...
template<typename T, typename K, typename series_templ>
T wynn_rho_algorithm<T, K, series_templ>::recursive_calculate_body(const K n, const int order, T S_n, const K j) const {
...
template<typename T, typename K, typename series_templ>
wynn_rho_algorithm<T, K, series_templ>::wynn_rho_algorithm(const series_templ &series, const numerator_base<T, K> *func, const T gamma_ , const T RHO_)
...
template<typename T, typename K, typename series_templ>
T wynn_rho_algorithm<T, K, series_templ>::operator()(const K n, const int order) const {
