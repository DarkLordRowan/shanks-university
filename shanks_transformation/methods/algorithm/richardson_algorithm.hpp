...
T richardson_algorithm<T, K>::operator()(
    ...
    if (data.Sn.size() < required_size){
        throw std::out_of_range("The Sn smaller then required for richardson_{" + to_string(order) + "}^{" + to_string(n) + "}\n" +
...
complex_precision<float_precision> richardson_algorithm<complex_precision<float_precision>, K>::operator()(
    ...
    if (data.Sn.size() < required_size){
        throw std::out_of_range("The Sn or an smaller then required for richardson_{" + to_string(order) + "}^{" + to_string(n) + "}\n" +
