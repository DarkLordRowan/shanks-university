...
public:
	...
	*/
	...
	inline constexpr T calculate_summm(const T& x){
...
template<AcceptedLike T, UnsignedIntLike K>
series_result<T> half_multi_ln_1div2multi1minuscosx_series<T, K>::generate_series(
    const T& x , 
	const K vecSize, 
	...
	series_base<T,K>::sum = calculate_summm(x);
