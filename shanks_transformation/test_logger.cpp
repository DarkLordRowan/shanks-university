...
void cmp_sum_and_transform_f(const K n, const K order, const series_templ&& series, const transform_type&& test, std::ofstream& f_stream)
{
...
*/
template <std::unsigned_integral K, typename series_templ, typename transform_type>
void cmp_a_n_and_transform_f(const K n, const K order, const series_templ&& series, const transform_type&& test, std::ofstream& f_stream)
{
...
*/
template <std::unsigned_integral K, typename series_templ, typename transform_type>
void transformation_remainders_f(const K n, const K order, const series_templ&& series, const transform_type&& test, std::ofstream& f_stream)
{
	long double result;
	for (K i = 1; i <= n; ++i)
	{
...
void cmp_transformations_f(const K n, const K order, const series_templ&& series, const transform_type_1&& test_1, const transform_type_2&& test_2, std::ofstream& f_stream)
{
...
*/
template <std::unsigned_integral K, typename series_templ, typename transform_type>
void eval_transform_time_f(const K n, const K order, const series_templ&& series, const transform_type&& test, std::ofstream& f_stream)
{
...
void print_sum_f(const K n, const series_templ&& series, std::ofstream& f_stream)
{
...
void print_transform_f(const K n, const K order, const transform_type&& test, std::ofstream& f_stream)
{
	long double result;
	try
	{
...
inline static void main_testing_function()
{
	...
	case test_function_id_t::cmp_sum_and_transform_id:
		cmp_sum_and_transform_f(n, order, std::move(series.get()), std::move(transform.get()), f);
		break;
	case test_function_id_t::cmp_a_n_and_transform_id:
		cmp_a_n_and_transform_f(n, order, std::move(series.get()), std::move(transform.get()), f);
		break;
	case test_function_id_t::transformation_remainder_id:
		transformation_remainders_f(n, order, std::move(series.get()), std::move(transform.get()), f);
		break;
