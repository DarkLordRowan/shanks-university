...
__all__: list[str] = [
    ...
    "PiXMultiE_XpiPlusEMinusXpiDividedE_XpiMinusEMinusXpiMinusOneSeriesArb",
    "PiXMultiE_XpiPlusEMinusXpiDividedE_XpiMinusEMinusXpiMinusOneSeriesF64",
    "RemainderType",
    ...
    "ShanksAlgorithmArb",
    "ShanksAlgorithmF64",
    "ShanksTransformAlternatingAlgorithmArb",
    "ShanksTransformAlternatingAlgorithmF64",
    "SiXSeriesArb",
    "SiXSeriesF64",
    "SinSeriesArb",
    "SinSeriesF64",
    ...
    "XSeriesArb",
    "XSeriesF64",
    "XTwelfthX2Pi2SeriesArb",
    "XTwelfthX2Pi2SeriesF64",
    "XTwoSeriesArb",
    "XTwoSeriesF64",
    "XTwoThroughtSquaresSeriesArb",
    "XTwoThroughtSquaresSeriesF64",
    "X_1mx_SquaredSeriesArb",
    "X_1mx_SquaredSeriesF64",
    "XmbJbTwoSeriesArb",
    "XmbJbTwoSeriesF64",
...
class LevinSidiMAlgorithmArb(SeriesAccelerationArb):
    def __init__(
        self, series: SeriesBaseArb, remainder: RemainderType = ..., gamma: Arb = ...
    ) -> None: ...

class LevinSidiMAlgorithmF64(SeriesAccelerationF64):
    def __init__(
        self, series: SeriesBaseF64, remainder: RemainderType = ..., gamma: float = 10.0
    ) -> None: ...
...
class NumeratorType:
    ...
    ]  # value = {'rho_variant': <NumeratorType.rho_variant: 0>, 'generalized_variant': <NumeratorType.generalized_variant: 1>, 'gamma_rho_variant': <NumeratorType.gamma_rho_variant: 2>}
    gamma_rho_variant: typing.ClassVar[
        NumeratorType
    ]  # value = <NumeratorType.gamma_rho_variant: 2>
    generalized_variant: typing.ClassVar[
        NumeratorType
    ]  # value = <NumeratorType.generalized_variant: 1>
    rho_variant: typing.ClassVar[
        NumeratorType
    ]  # value = <NumeratorType.rho_variant: 0>
...
class PiXMultiE_XpiPlusEMinusXpiDividedE_XpiMinusEMinusXpiMinusOneSeriesArb(
    SeriesBaseArb
):
    def __init__(self, arg0: Arb) -> None: ...

class PiXMultiE_XpiPlusEMinusXpiDividedE_XpiMinusEMinusXpiMinusOneSeriesF64(
    SeriesBaseF64
):
    def __init__(self, arg0: float) -> None: ...
...
class RemainderType:
    ...
    ]  # value = {'u_variant': <RemainderType.u_variant: 0>, 't_variant': <RemainderType.t_variant: 1>, 'v_variant': <RemainderType.v_variant: 2>, 't_wave_variant': <RemainderType.t_wave_variant: 3>, 'v_wave_variant': <RemainderType.v_wave_variant: 4>}
    t_variant: typing.ClassVar[RemainderType]  # value = <RemainderType.t_variant: 1>
    t_wave_variant: typing.ClassVar[
        RemainderType
    ]  # value = <RemainderType.t_wave_variant: 3>
    ...
    v_wave_variant: typing.ClassVar[
        RemainderType
    ]  # value = <RemainderType.v_wave_variant: 4>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class WynnEpsilon3AlgorithmF64(SeriesAccelerationF64):
    def __init__(
        self, series: SeriesBaseF64, epsilon_threshold: float = 0.001
    ) -> None: ...
