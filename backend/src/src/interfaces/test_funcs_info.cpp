 ...
 * @brief This file contains the implementation of the metadata retrieval for test functions.
 * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
 */

/**
 * @brief Virtual destructor for the test function information interface.
 * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
 */
ITestFunctionInfo::~ITestFunctionInfo() {}

// Retrieval of unique IDs for each test function
...
// Retrieval of internal names for each test function
...
// Retrieval of human-readable descriptions for each test function
