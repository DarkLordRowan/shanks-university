...
enum class series_iterator_id_t {
									   ...
									   abs_sin_x_minus_2_div_pi_iterator_id,
													  arcsinh_x_iterator_id,
													  arcsin_x2_iterator_id,
											   arcsin_x_minus_x_iterator_id,
													   arcsin_x_iterator_id,
													 arctanh_x2_iterator_id,
													  arctanh_x_iterator_id,
													   arctg_x2_iterator_id,
													   arctg_x3_iterator_id,
														arctg_x_iterator_id,
															bin_iterator_id,
														   ci_x_iterator_id,
										  cos3xmin1_div_xsquare_iterator_id,
														   cosh_iterator_id,
															cos_iterator_id,
													 cos_sqrt_x_iterator_id,
														 cos_x2_iterator_id,
										  eighth_pi_m_one_third_iterator_id,
															erf_iterator_id,
										   exp_m_cos_x_sinsin_x_iterator_id,
															exp_iterator_id,
												exp_squared_erf_iterator_id,
															e_x_iterator_id,
												 five_pi_twelve_iterator_id,
												    four_arctan_iterator_id,
												   four_ln2_m_3_iterator_id,
											    half_asin_two_x_iterator_id,
									 half_minus_sinx_multi_pi_4_iterator_id,
							 half_multi_ln_1div2multi1minuscosx_iterator_id,
										  incomplete_Gamma_func_iterator_id,
												    inverse_1mx_iterator_id,
											  inverse_sqrt_1m4x_iterator_id,
															k_x_iterator_id,
												 lambert_W_func_iterator_id,
											 ln13_min_ln7_div_7_iterator_id,
													   ln1_m_x2_iterator_id,
														  ln1mx_iterator_id,
							ln_1plussqrt1plusxsquare_minus_ln_2_iterator_id,
												   ln_1_plus_x3_iterator_id,
										  ln_1plusx_div_1plusx2_iterator_id,
														 ln1px4_iterator_id,
															ln2_iterator_id,
														ln_cosx_iterator_id,
											 ln_sinx_minus_ln_x_iterator_id,
							   ln_x_plus_one_x_minus_one_halfed_iterator_id,
												  mean_sinh_sin_iterator_id,
										 m_fact_1mx_mp1_inverse_iterator_id,
							   minus_3_div_4_or_x_minus_3_div_4_iterator_id,
											 minus_one_ned_in_n_iterator_id,
										minus_one_n_fact_n_in_n_iterator_id,
											  minus_one_quarter_iterator_id,
			minus_three_plus_ln3_three_devided_two_plus_two_ln2_iterator_id,
							   minus_x_minus_pi_4_or_minus_pi_4_iterator_id,
									one_div_sqrt2_sin_xdivsqrt2_iterator_id,
						 one_div_two_minus_x_multi_three_plus_x_iterator_id,
								 one_minus_sqrt_1minus4x_div_2x_iterator_id,
															one_iterator_id,
									one_third_pi_squared_m_nine_iterator_id,
										    one_twelfth_3x2_pi2_iterator_id,
													one_twelfth_iterator_id,
											 one_twelfth_x2_pi2_iterator_id,
														   pi_3_iterator_id,
														   pi_4_iterator_id,
							pi_8_cosx_square_minus_1_div_3_cosx_iterator_id,
												 	pi_cubed_32_iterator_id,
									   pi_four_minus_ln2_halfed_iterator_id,
					  pi_minus_3pi_4_and_pi_minus_x_minus_3pi_4_iterator_id,
												   pi_minus_x_2_iterator_id,
						    								 pi_iterator_id,
						    				    pi_six_min_half_iterator_id,
						    			 pi_squared_6_minus_one_iterator_id,
						    				  pi_squared_twelve_iterator_id,
 pi_x_minus_x_square_square_minus_three_pi_x_plus_two_pi_square_iterator_id,
pi_x_multi_e_xpi_plus_e_minusxpi_divided_e_xpi_minus_e_minusxpi_iterator_id,
											  riemann_zeta_func_iterator_id,
				riemann_zeta_func_xmin1_div_Riemann_zeta_func_x_iterator_id,
				      					 series_with_ln_number1_iterator_id,
				      					 series_with_ln_number2_iterator_id,
				      									   sinh_iterator_id,
				      									sinh_x2_iterator_id,
				      									    sin_iterator_id,
				      									 sin_x2_iterator_id,
				      									   si_x_iterator_id,
				    			  sqrt_1plusx_min_1_min_x_div_2_iterator_id,
				    								sqrt_1plusx_iterator_id,
				    		   sqrt_oneminussqrtoneminusx_div_x_iterator_id,
				    							    ten_minus_x_iterator_id,
				    							 three_minus_pi_iterator_id,
				    				 two_arcsin_square_x_halfed_iterator_id,
				    							   two_degree_x_iterator_id,
				    									two_ln2_iterator_id,
				    							  x_1mx_squared_iterator_id,
				    							   x_div_1minx2_iterator_id,
				    								x_div_1minx_iterator_id,
				    							   x_min_sqrt_x_iterator_id,
				    								 		  x_iterator_id,
				    xsquareplus3_div_xsquareplus2multix_minus_1_iterator_id,
				    					 				  x_two_iterator_id,
