...
namespace shanks
{
    namespace algos
    {
        ...
        public:
             ...
             * [https://arxiv.org/pdf/math/0306302.pdf] Default value: 1.0. Affects the remainder estimate in u-variant.
             *        For theory, see: Sidi & Levin (1981), Eq. (3.4) and surrounding discussion
             */
            explicit levin_algorithm(const shanks::remainders::remainder_type remainder_type_to_use =
