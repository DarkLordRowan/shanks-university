...
namespace shanks
{
    namespace algos
    {
        ...
        public:
             ...
             * [https://arxiv.org/pdf/math/0306302.pdf] Default value: 10.0. Affects the factorial terms in the
             * transformation. For theory, see: Sidi (2003, arXiv:math/0306302), p. 64
             */
        ...
        T levin_sidi_m_algorithm<T, K>::operator()(const K n, const K order, const series_result<T>& data) const
        {
            ...
            if (gamma_in_use - utils::cast<float_type>(static_cast<double>(n)) - utils::cast<float_type>(1.0) <
                utils::cast<float_type>(0.0))
            {
            ...
            for (K j = static_cast<K>(0); j <= n; ++j)
            {
                ...
                up *= (down_coef + utils::cast<float_type>(
