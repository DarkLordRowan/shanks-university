...
template<typename T> requires std::numeric_limits<T>::is_integer struct is_standard_types<T> : public std::true_type {};
template<typename T> requires std::numeric_limits<T>::is_integer struct is_standard_types<std::complex<T>> : public std::true_type {};
template<std::floating_point T> struct is_standard_types<T> : public std::true_type {};
template<std::floating_point T> struct is_standard_types<std::complex<T>> : public std::true_type {};
