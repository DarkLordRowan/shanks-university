...
struct utils::math<OpsWrapperMacro(T)> {
    ...
    static OpsWrapperMacro(T) fma(const OpsWrapperMacro(T)& a, const OpsWrapperMacro(T)& b, const OpsWrapperMacro(T)& c);
...
template <typename T>
OpsWrapperMacro(T) utils::math<OpsWrapperMacro(T)>::binomial_coefficient(const OpsWrapperMacro(T) n, const OpsWrapperMacro(T) k) {
...
template <typename T>
OpsWrapperMacro(T) utils::math<OpsWrapperMacro(T)>::fma(const OpsWrapperMacro(T)& a, const OpsWrapperMacro(T)& b, const OpsWrapperMacro(T)& c) {
    shanks::profiling::global_operation_counts.special++;
...
template <typename T>
OpsWrapperMacro(T) utils::math<OpsWrapperMacro(T)>::inc_gamma(const OpsWrapperMacro(T)& x, const OpsWrapperMacro(T)& alpha) {
    shanks::profiling::global_operation_counts.special++;
