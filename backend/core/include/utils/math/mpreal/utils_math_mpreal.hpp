...
template <std::integral K>
inline mpfr::mpreal utils::math<mpfr::mpreal>::minus_one_raised_to_power_n(const K j) {
...
inline mpfr::mpreal utils::math<mpfr::mpreal>::sqrt(const mpfr::mpreal& x) { return mpfr::sqrt(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::exp(const mpfr::mpreal& x) { return mpfr::exp(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::log(const mpfr::mpreal& x) { return mpfr::log(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::log10(const mpfr::mpreal& x) { return mpfr::log10(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::hypot(const mpfr::mpreal& a, const mpfr::mpreal& b) {
...
inline mpfr::mpreal utils::math<mpfr::mpreal>::si_x(const mpfr::mpreal& x) {
...
inline mpfr::mpreal utils::math<mpfr::mpreal>::sin(const mpfr::mpreal& x) { return mpfr::sin(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::asin(const mpfr::mpreal& x) { return mpfr::asin(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::cos(const mpfr::mpreal& x) { return mpfr::cos(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::acos(const mpfr::mpreal& x) { return mpfr::acos(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::tan(const mpfr::mpreal& x) { return mpfr::tan(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::atan(const mpfr::mpreal& x) { return mpfr::atan(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::sinh(const mpfr::mpreal& x) { return mpfr::sinh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::asinh(const mpfr::mpreal& x) { return mpfr::asinh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::cosh(const mpfr::mpreal& x) { return mpfr::cosh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::acosh(const mpfr::mpreal& x) { return mpfr::acosh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::tanh(const mpfr::mpreal& x) { return mpfr::tanh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::atanh(const mpfr::mpreal& x) { return mpfr::atanh(x); }

inline mpfr::mpreal utils::math<mpfr::mpreal>::abs(const mpfr::mpreal& x) { return mpfr::abs(x); }
