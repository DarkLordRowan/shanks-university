...
struct utils {
    ...
    constexpr static K fact(const K n);
     ...
     */
    template <UnsignedIntLike K>
    constexpr static K double_fact(const K n);
     ...
     */
    template <UnsignedIntLike K>
    constexpr static K binomial_coefficient(const K n, const K k);
     ...
     */
    template <AcceptedLike T, UnsignedIntLike K>
    constexpr static T minus_one_raised_to_power_n(const K j);
