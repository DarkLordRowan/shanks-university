...
namespace shanks
{
    namespace series
    {
        ...
        public:
             ...
             * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
             */
            explicit sinh_x2_iterator(T x) : series_base_succ<T, K>(x)
            {
                if (this->is_invalid())
            ...
            {
                return utils::sinh(this->x * this->x);
            }
            ...
            T next(K n, T& state) const override
            {
                ...
                if (n == 0)
                    ...
                    state *=
                        ...
                        utils::cast<T>(
                            utils::fma(static_cast<size_t>(2), static_cast<size_t>(n), static_cast<size_t>(1)) * 2 * n);
                return state;
            }
        };
