...
namespace shanks
{
    namespace series
    {
        ...
        public:
            ...
            {
                return this->x * utils::cast<T>(-0.65583160);
            }
            ...
            T next(K n, T& state) const override
            {
                ...
                state = utils::minus_one_raised_to_power_n<T, K>(n + 1) * utils::cast<T>(utils::fact<K>(n + 1)) *
                        this->x / utils::cast<T>(utils::pow(n + 1, n + 1));
                return state;
            }
        };
