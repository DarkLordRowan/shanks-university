...
public:
     ...
     */
    T get_sum() const override { return this->x * utils::cast<T>::meta(-0.78343051); }
    ...
    T next(K n, T& state) const override {
        ...
        state = utils::minus_one_raised_to_power_n<T, K>(n + 1) * this->x / utils::cast<T>::meta(utils::pow(n + 1, n + 1));
        return state;
    }
};
