...
namespace shanks
{
    namespace series
    {
        ...
        class arcsin_x2_iterator final : public series_base_succ<T, K>
        {
        public:
            /**
             ...
             * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
             */
            explicit arcsin_x2_iterator(T x) : series_base_succ<T, K>(x)
            {
                if (this->is_invalid())
            ...
            {
                return utils::asin(this->x * this->x);
            }
                ...
                if (n == 0)
                    ...
                    state *=
                        ...
                        utils::cast<T>(
                            ...
                            utils::fma(static_cast<size_t>(2), static_cast<size_t>(n - 1), static_cast<size_t>(1))) /
                        utils::cast<T>(
                            2 * n * utils::fma(static_cast<size_t>(2), static_cast<size_t>(n), static_cast<size_t>(1)));
                return state;
            }
        };
