...
namespace shanks
{
    namespace series
    {
        ...
        public:
             ...
             * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
             */
            explicit mean_sinh_sin_iterator(T x) : series_base_succ<T, K>(x)
            {
                if (this->is_invalid())
            ...
            {
                return (utils::sinh(this->x) + utils::sin(this->x)) * utils::cast<T>(0.5);
            }
            ...
            T next(K n, T& state) const override
            {
                ...
                if (n == 0)
                    ...
                    state *=
                        utils::pow(this->x, utils::cast<T>(4)) /
                        utils::cast<T>(
                            utils::fma(static_cast<size_t>(4), static_cast<size_t>(n - 1), static_cast<size_t>(5)) *
                            utils::fma(static_cast<size_t>(4), static_cast<size_t>(n - 1), static_cast<size_t>(4)) *
                            utils::fma(static_cast<size_t>(4), static_cast<size_t>(n - 1), static_cast<size_t>(3)) *
                            utils::fma(static_cast<size_t>(4), static_cast<size_t>(n - 1), static_cast<size_t>(2)));
                return state;
            }
        };
