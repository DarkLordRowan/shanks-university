...
namespace shanks
{
    namespace series
    {
        ...
        class pi_x_minus_x_square_square_minus_three_pi_x_plus_two_pi_square_iterator final
            : public series_base_succ<T, K>
        {
        public:
            /**
             ...
             * @authors Naumov A.U., Lykov D.S., Kreynin R.G.
             */
            explicit pi_x_minus_x_square_square_minus_three_pi_x_plus_two_pi_square_iterator(T x)
                : series_base_succ<T, K>(x)
            {
                if (this->is_invalid())
            ...
            T next(K n, T& state) const override
            {
                ...
                state = utils::cast<T>(8) *
                        utils::sin(utils::cast<T>(utils::fma(
