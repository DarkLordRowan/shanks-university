...
void bind_types(py::module_& m)
{
    ...
    auto cf32 =
        py::class_<std::complex<float>>(m, "CF32")
            ...
            .def(py::pickle([](const std::complex<float>& c) { return py::make_tuple(c.real(), c.imag()); },
    ...
    auto cf64 =
        py::class_<std::complex<double>>(m, "CF64")
            ...
            .def(py::pickle([](const std::complex<double>& c) { return py::make_tuple(c.real(), c.imag()); },
    ...
    auto cfLong =
        py::class_<std::complex<long double>>(m, "CFLong")
            ...
            .def(py::pickle([](const std::complex<long double>& c) { return py::make_tuple(c.real(), c.imag()); },
                            [](py::tuple t) {
    ...
    py::class_<mpfr::mpreal>(m, "Arb")
        ...
        .def(py::pickle([](const mpfr::mpreal& num) { return num.toString(); },
    ...
    auto cArb =
        py::class_<std::complex<mpfr::mpreal>>(m, "CArb")
            ...
            .def(py::pickle([](const std::complex<mpfr::mpreal>& c) { return py::make_tuple(c.real(), c.imag()); },
                            [](py::tuple t) {
