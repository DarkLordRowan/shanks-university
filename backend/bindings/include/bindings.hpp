...
using types_real = std::tuple<std::tuple<float, size_t>,
                              std::tuple<double, size_t>,
                              std::tuple<long double, size_t>,
                              std::tuple<mpfr::mpreal, size_t>>;

using types_complex = std::tuple<std::tuple<std::complex<float>, size_t>,
...
using types_to_bind = std::tuple<std::tuple<float, size_t>,
                                 std::tuple<double, size_t>,
                                 std::tuple<long double, size_t>,
                                 std::tuple<mpfr::mpreal, size_t>,
