...
public:
    ...
    virtual std::unique_ptr<CSeries> apply_noise(rust::Str name, rust::Str params_json) const = 0;
    virtual std::unique_ptr<CSeries> run_algo(rust::Str name, rust::Str params_json) const = 0;
    virtual RawArr filter(rust::Str name, rust::Str params_json) const = 0;
};
...
RawArr filter(const CSeries& series, rust::Str name, rust::Str params_json);
